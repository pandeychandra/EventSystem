...
/* String nameE = o.getString("eventname");
                        ...
                        DataSave dataSave = new DataSave(o.getString("eventname"), o.getString("location"),
                                ...
                                o.getString("token"), o.getString("Description"), o.getString("time"),
                                o.getString("category")
                                , o.getString("categoryprice"),  o.getString("id"));
                        list1.add(dataSave);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            pastEventAdapter=new PastEventAdapter(getActivity(),list1);
